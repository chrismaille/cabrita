...
class Box:
    ...
    def interval(self):
        """
        Return interval in seconds for each box data update. Minimum: 0.5.
        :return: float
        """
    ...
    def show_git(self) -> bool:
        """
        Return if box will show git information (the 'show_git' box parameter). Default: True.
        :return: bool
        """
    ...
    def show_revision(self) -> bool:
        """
        Return if box will show git tag/commit hash (the 'show_revision" box parameter). Default: False.
        :return:
        """
    ...
    def port_view(self) -> PortView:
        """
        Return if box will show docker container port info (the 'port_view' box parameter). Default: hidden.
    ...
    def categories(self) -> List[str]:
        """
        Return if box will show services as columns (categories). Default: Show as lines.
        :return: list
        """
    ...
    def title(self) -> str:
        """
        Return box title name (the 'name' box parameter). Default: "Box".
        :return: string
        """
    ...
    def size(self) -> str:
        """
        Return box size to render in dashboard (the 'size' box parameter). Default: "large".
        :return: string
        """
    ...
    def main(self) -> bool:
        """
        Return if this is the main box (the 'main' box parameter). Default: No
    ...
    def includes(self) -> list:
        ...
        (the 'includes' box parameter). Default is: no filters.
    ...
    def run(self) -> None:
        """
        The main run code for update box data.
